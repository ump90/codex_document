...
- [Codex](zh/pages/01-codex.md)
- [Codex 定价](zh/pages/02-codex-pricing.md)
- [功能成熟度](zh/pages/03-feature-maturity.md)
- [快速开始](zh/pages/04-quickstart.md)

### 执行模型与工作流

- [最佳实践](zh/pages/05-best-practices.md)
- [示例工作流](zh/pages/06-example-workflows.md)
- [提示](zh/pages/07-prompting.md)
- [速度](zh/pages/08-speed.md)

### 审批、沙盒与安全

- [Codex Security 常见问题](zh/pages/09-codex-security-faq.md)
- [Codex Security 插件](zh/pages/10-codex-security-plugin.md)
- [Codex Security 设置](zh/pages/11-codex-security-setup.md)
- [改进威胁模型](zh/pages/12-improving-the-threat-model.md)
- [智能体审批和安全](zh/pages/13-agent-approvals-security.md)
- [网络安全](zh/pages/14-cyber-safety.md)
- [沙盒](zh/pages/15-sandbox.md)

### 配置、认证与模型

- [配置参考](zh/pages/16-configuration-reference.md)
- [高级配置](zh/pages/17-advanced-configuration.md)
- [身份验证和会话](zh/pages/18-authentication-and-sessions.md)
- [配置基础](zh/pages/19-config-basics.md)
- [模型选择](zh/pages/20-model-selection.md)
- [示例配置](zh/pages/21-sample-configuration.md)

### CLI、IDE、应用与云行为

- [CLI 命令参考](zh/pages/22-cli-command-reference.md)
- [智能体互联网访问](zh/pages/23-agent-internet-access.md)
- [自动化](zh/pages/24-automations.md)
- [云环境](zh/pages/25-cloud-environments.md)
- [Codex 应用命令](zh/pages/26-codex-app-commands.md)
- [Codex 应用功能](zh/pages/27-codex-app-features.md)
- [Codex 应用设置](zh/pages/28-codex-app-settings.md)
- [Codex Chrome 扩展](zh/pages/29-codex-chrome-extension.md)
- [Codex CLI 功能](zh/pages/30-codex-cli-features.md)
- [Codex IDE 扩展命令](zh/pages/31-codex-ide-extension-commands.md)
- [Codex IDE 扩展功能](zh/pages/32-codex-ide-extension-features.md)
- [Codex IDE 扩展设置](zh/pages/33-codex-ide-extension-settings.md)
- [Codex IDE 扩展斜杠命令](zh/pages/34-codex-ide-extension-slash-commands.md)
- [计算机使用](zh/pages/35-computer-use.md)
- [应用内浏览器](zh/pages/36-in-app-browser.md)
- [本地环境](zh/pages/37-local-environments.md)
- [审查](zh/pages/38-review.md)
- [Codex CLI 中的斜杠命令](zh/pages/39-slash-commands-in-codex-cli.md)
- [故障排查](zh/pages/40-troubleshooting.md)
- [Windows 应用](zh/pages/41-windows-app.md)
- [工作树](zh/pages/42-worktrees.md)
- [Appshots（应用快照）](zh/pages/43-appshots.md)
- [Codex 应用](zh/pages/44-codex-app.md)
- [Codex CLI](zh/pages/45-codex-cli.md)
- [Codex IDE 扩展](zh/pages/46-codex-ide-extension.md)
- [Codex 网页版](zh/pages/47-codex-web.md)

### 自定义、技能、规则、MCP 与集成

- [智能体技能](zh/pages/48-agent-skills.md)
- [GitHub 中的 Codex 代码审查](zh/pages/49-codex-code-review-in-github.md)
- [使用 AGENTS.md 自定义说明](zh/pages/50-custom-instructions-with-agents-md.md)
- [自定义提示](zh/pages/51-custom-prompts.md)
- [自定义](zh/pages/52-customization.md)
- [模型上下文协议（MCP）](zh/pages/53-model-context-protocol.md)
- [规则](zh/pages/54-rules.md)
- [在 Linear 中使用 Codex](zh/pages/55-use-codex-in-linear.md)
- [在 Slack 中使用 Codex](zh/pages/56-use-codex-in-slack.md)

### 非交互和编程接口

- [Codex App Server（应用服务器）](zh/pages/57-codex-app-server.md)
- [Codex GitHub Action（GitHub 动作）](zh/pages/58-codex-github-action.md)
- [Codex SDK](zh/pages/59-codex-sdk.md)
- [非交互模式](zh/pages/60-non-interactive-mode.md)
- [将 Codex 与 Agents SDK 配合使用](zh/pages/61-use-codex-with-the-agents-sdk.md)

### 平台、企业与注意事项

- [环境变量](zh/pages/62-environment-variables.md)
- [访问令牌](zh/pages/63-access-tokens.md)
- [管理员设置](zh/pages/64-admin-setup.md)
- [自动审查](zh/pages/65-auto-review.md)
- [治理](zh/pages/66-governance.md)
- [托管配置](zh/pages/67-managed-configuration.md)
- [子智能体](zh/pages/68-subagents.md)
- [构建插件](zh/pages/69-build-plugins.md)
- [Chronicle（长期记忆）](zh/pages/70-chronicle.md)
- [Codex 安全](zh/pages/71-codex-security.md)
- [术语表](zh/pages/72-glossary.md)
- [钩子](zh/pages/73-hooks.md)
- [记忆](zh/pages/74-memories.md)
- [迁移到 Codex](zh/pages/75-migrate-to-codex.md)
- [开源](zh/pages/76-open-source.md)
- [权限](zh/pages/77-permissions.md)
- [插件](zh/pages/78-plugins.md)
- [远程连接](zh/pages/79-remote-connections.md)
- [Sites（站点）](zh/pages/80-sites.md)
- [子智能体](zh/pages/81-subagents-2.md)
...
![展示项目侧边栏、线程列表和审查面板的 Codex app](https://developers.openai.com/images/codex/app/codex-app-basic-light.webp)

Codex 是 OpenAI 面向软件开发的编程代理。ChatGPT Plus、Pro、Business、Edu 和 Enterprise 计划均包含 Codex。它可以帮助你：

- **编写代码**：描述你想构建的内容，Codex 会生成符合你意图的代码，并适配你现有项目的结构和约定。

- **理解陌生代码库**：Codex 可以阅读并解释复杂或遗留代码，帮助你掌握团队如何组织系统。

- **审查代码**：Codex 会分析代码，识别潜在 bug、逻辑错误和未处理的边界情况。

- **调试并修复问题**：当出现故障时，Codex 会帮助追踪失败、诊断根因，并建议有针对性的修复。

- **自动化开发任务**：Codex 可以运行重复性工作流，例如重构、测试、迁移和设置任务，让你专注于更高层次的工程工作。

[开始使用 Codex](zh/pages/04-quickstart.md)

#### 探索 Codex

- [快速开始](zh/pages/04-quickstart.md)：下载 Codex 并开始构建。
- [探索使用场景](zh/pages/97-use-cases.md)：获取可以用 Codex 构建什么的灵感。
- [社区](https://developers.openai.com/community)：阅读社区文章、探索 meetup，并连接 Codex 构建者。
- [Codex for Open Source](https://developers.openai.com/community/codex-for-oss)：为维护者申请或提名 API credits、带 Codex 的 ChatGPT Pro，以及部分 Codex Security 访问权限。
...
[Sites](zh/pages/80-sites.md) 在预览期间免费。定价信息会稍后公布。
...
Speed 配置会提高所有适用模型的点数消耗，因此也会更快使用包含的额度。Fast mode 对受支持模型会以更高速率消耗点数。请参阅 [Speed](zh/pages/08-speed.md) 了解受支持模型和速率。图像生成也会更快使用包含的额度，平均约为 3-5 倍，具体取决于图像质量和尺寸。GPT-5.3-Codex-Spark 仅面向 ChatGPT Pro 用户研究预览，发布时不在 API 中提供。由于它运行在专用低延迟硬件上，用量受单独的使用限制约束，并可能根据需求调整。
...
GPT-5.5 每条消息平均消耗 5-45 点数。Fast mode 对受支持模型会以更高速率消耗点数。请参阅 [Speed](zh/pages/08-speed.md) 了解费率。

Speed 配置会提高所有适用模型的点数消耗。Fast mode 对受支持模型会以更高速率消耗点数。请参阅 [Speed](zh/pages/08-speed.md) 了解受支持模型和费率。
...
- **减少 AGENTS.md 的大小。** 如果在较大项目中工作，可以通过[在仓库内嵌套 AGENTS.md](zh/pages/50-custom-instructions-with-agents-md.md#layer-project-instructions) 控制注入多少上下文。
- **限制使用的 MCP 服务器数量。** 添加到 Codex 的每个 [MCP](zh/pages/53-model-context-protocol.md) 都会给消息增加更多上下文，并消耗更多额度。不需要时请禁用 MCP 服务器。
...
| --- | --- | --- | --- | --- | --- |
| [Codex web](zh/pages/47-codex-web.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [用于本地任务的 Codex app](zh/pages/44-codex-app.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Codex CLI](zh/pages/45-codex-cli.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [IDE 扩展](zh/pages/46-codex-ide-extension.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Codex SDK、`codex exec` 和可脚本化工作流](zh/pages/59-codex-sdk.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [用于可信自动化的 Codex access token](zh/pages/63-access-tokens.md) | 不可用 | 不可用 | 可用 | 可用 | 不可用 |

### 模型与多模态

| 功能 | Plus | Pro | Business | Enterprise/Edu | API Key |
| --- | --- | --- | --- | --- | --- |
| [Fast mode](zh/pages/08-speed.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Codex-Spark 研究预览](zh/pages/20-model-selection.md) | 不可用 | 可用 | 不可用 | 不可用 | 不可用 |
| [图像生成与编辑](zh/pages/27-codex-app-features.md#image-generation) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [语音听写](zh/pages/27-codex-app-features.md#voice-dictation) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [网页搜索](zh/pages/27-codex-app-features.md#web-search) | 可用 | 可用 | 可用 | 可用 | 可用 |

### 本地功能

| 功能 | Plus | Pro | Business | Enterprise/Edu | API Key |
| --- | --- | --- | --- | --- | --- |
| [使用 `/review` 进行本地代码审查](zh/pages/06-example-workflows.md#do-a-local-code-review) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [审批请求的自动审查](zh/pages/65-auto-review.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [沙箱和权限控制](zh/pages/77-permissions.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [项目和独立 app 自动化](zh/pages/24-automations.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [自动化](zh/pages/24-automations.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Worktree 和内置 Git 工具](zh/pages/42-worktrees.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [本地环境和可重复操作](zh/pages/37-local-environments.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Appshots](zh/pages/43-appshots.md) | 可用 | 可用 | 可用 | 不可用 | 可用 |

### 浏览器与远程控制

| 功能 | Plus | Pro | Business | Enterprise/Edu | API Key |
| --- | --- | --- | --- | --- | --- |
| [App 内浏览器预览与评论](zh/pages/36-in-app-browser.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Browser Use 自动化](zh/pages/36-in-app-browser.md#browser-use) | 有限开放* | 有限开放* | 有限开放* | 有限开放* | 有限开放* |
| [Chrome 扩展浏览器控制](zh/pages/29-codex-chrome-extension.md) | 有限开放* | 有限开放* | 有限开放* | 有限开放* | 有限开放* |
| [Computer Use](zh/pages/35-computer-use.md) | 有限开放* | 有限开放* | 有限开放* | 有限开放* | 有限开放* |
| [SSH 远程连接](zh/pages/79-remote-connections.md#connect-to-an-ssh-host) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [移动端远程控制](zh/pages/79-remote-connections.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |

### 自定义与扩展

| 功能 | Plus | Pro | Business | Enterprise/Edu | API Key |
| --- | --- | --- | --- | --- | --- |
| [使用 `AGENTS.md` 编写自定义指令](zh/pages/50-custom-instructions-with-agents-md.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Skills](zh/pages/48-agent-skills.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Plugins](zh/pages/78-plugins.md) | 可用 | 可用 | 可用 | 可用 | 部分可用† |
| [Plugin 共享](zh/pages/69-build-plugins.md#share-a-local-plugin-with-your-workspace) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [App connectors](zh/pages/78-plugins.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [MCP](zh/pages/53-model-context-protocol.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Subagents 和自定义 agents](zh/pages/81-subagents-2.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [Memories](zh/pages/74-memories.md) | 有限开放* | 有限开放* | 有限开放* | 有限开放* | 有限开放* |
| [Chronicle](zh/pages/70-chronicle.md) | 不可用 | 有限开放* | 不可用 | 不可用 | 不可用 |

### 云端与集成

| 功能 | Plus | Pro | Business | Enterprise/Edu | API Key |
| --- | --- | --- | --- | --- | --- |
| [Codex 云任务](zh/pages/47-codex-web.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [云环境和 setup scripts](zh/pages/25-cloud-environments.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [云端 agent 互联网访问控制](zh/pages/23-agent-internet-access.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [Sites](zh/pages/80-sites.md) | 不可用 | 不可用 | 可用 | 可用 | 不可用 |
| [使用 `@codex` 委派 GitHub issue 和 PR](zh/pages/49-codex-code-review-in-github.md#give-codex-other-tasks) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [GitHub 代码审查和自动 PR 审查](zh/pages/49-codex-code-review-in-github.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [Slack 云集成](zh/pages/56-use-codex-in-slack.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |
| [Linear 云集成](zh/pages/55-use-codex-in-linear.md) | 可用 | 可用 | 可用 | 可用 | 不可用 |

### 管理、安全与分析

| 功能 | Plus | Pro | Business | Enterprise/Edu | API Key |
| --- | --- | --- | --- | --- | --- |
| [SAML SSO、MFA 和 workspace 用户管理](zh/pages/64-admin-setup.md) | 不可用 | 不可用 | 可用 | 可用 | 不可用 |
| [`requirements.toml` 托管配置](zh/pages/67-managed-configuration.md) | 可用 | 可用 | 可用 | 可用 | 可用 |
| [云端托管配置策略](zh/pages/67-managed-configuration.md#cloud-managed-requirements) | 不可用 | 不可用 | 可用 | 可用 | 不可用 |
| [Codex RBAC 和自定义角色](zh/pages/64-admin-setup.md#step-2-set-up-custom-roles-rbac) | 不可用 | 不可用 | 不可用 | 可用 | 不可用 |
| [SCIM、EKM 和域名验证](zh/pages/64-admin-setup.md#enterprise-grade-security-and-privacy) | 不可用 | 不可用 | 不可用 | 可用 | 不可用 |
| [企业级保留和驻留控制](zh/pages/64-admin-setup.md#enterprise-grade-security-and-privacy) | 不可用 | 不可用 | 不可用 | 可用 | 不可用 |
| [默认不使用 API 或业务数据训练](https://openai.com/business-data/) | 不可用 | 不可用 | 可用 | 可用 | 可用 |
| [分析仪表板](zh/pages/66-governance.md#analytics-dashboard) | 不可用 | 不可用 | 不可用 | 可用 | 不可用 |
| [Analytics API](zh/pages/66-governance.md#analytics-api) | 不可用 | 不可用 | 不可用 | 可用 | 不可用 |
| [Compliance API 和审计日志](zh/pages/66-governance.md#compliance-api) | 不可用 | 不可用 | 不可用 | 可用 | 不可用 |
| [用于已连接 GitHub 仓库的 Codex Security](zh/pages/71-codex-security.md) | 不可用 | 不可用 | 不可用 | 可用 | 不可用 |
...
如果需要更多灵感，请浏览 [Codex 使用场景](zh/pages/97-use-cases.md)。如果你刚开始使用 Codex，请阅读[最佳实践指南](zh/pages/05-best-practices.md)。
...
4. 使用 Git 检查点。
   ...
   如果你刚开始使用 Codex，请阅读[最佳实践指南](zh/pages/05-best-practices.md)。

更多信息请参阅 [Codex IDE extension](zh/pages/46-codex-ide-extension.md)。
...
1. 安装 Codex CLI。
   ...
   对于无人值守安装，请在运行已下载安装器的 shell 中设置 `CODEX_NON_INTERACTIVE=1`。详情请参阅[环境变量](zh/pages/62-environment-variables.md#installer-variables)。
...
更多信息请参阅 [Codex CLI](zh/pages/45-codex-cli.md)。
...
更多信息请参阅 [Codex cloud](zh/pages/47-codex-web.md)。
...
- [进一步了解 Codex app](zh/pages/44-codex-app.md)：使用 Codex app 处理本地项目。
- [迁移到 Codex](zh/pages/75-migrate-to-codex.md)：把受支持的指令文件、MCP server 配置、skills 和 subagents 迁移到 Codex。
...
请将本页作为 Codex 配置文件的可搜索参考。有关概念性指导和示例，请先阅读 [配置基础](zh/pages/19-config-basics.md) 和 [高级配置](zh/pages/17-advanced-configuration.md)。

### `config.toml`

用户级配置位于 `~/.codex/config.toml`。你也可以在 `.codex/config.toml` 文件中添加项目范围覆盖。Codex 只有在你信任该项目时才会加载项目范围配置文件。

项目范围配置不能覆盖机器本地的提供商、认证、宿主持有的 app 请求元数据、通知、配置档选择或遥测路由 key。当 `openai_base_url`、`chatgpt_base_url`、`apps_mcp_product_sku`、`model_provider`、`model_providers`、`notify`、`profile`、`profiles`、`experimental_realtime_ws_base_url` 和 `otel` 出现在项目本地 `.codex/config.toml` 中时，Codex 会忽略它们；请改为把提供商、通知和遥测 key 放在用户级配置中。[配置档文件](zh/pages/17-advanced-configuration.md#profiles) 与 `config.toml` 位于同一目录，形式为 `$CODEX_HOME/profile-name.config.toml`；使用 `--profile profile-name` 选择。

对于沙箱和审批相关 key（`approval_policy`、`sandbox_mode` 和 `sandbox_workspace_write.*`），请将本参考与 [沙箱和审批](zh/pages/13-agent-approvals-security.md#sandbox-and-approvals)、[可写根目录中的受保护路径](zh/pages/13-agent-approvals-security.md#protected-paths-in-writable-roots) 和 [网络访问](zh/pages/13-agent-approvals-security.md#network-access) 一起阅读。Beta 版权限配置档请参阅 [权限](zh/pages/77-permissions.md)。
...
| `features.memories` | `boolean` | 启用 [Memories](zh/pages/74-memories.md)（默认关闭）。 |
...
`requirements.toml` 是管理员强制配置文件，用于约束用户无法覆盖的安全敏感设置。有关详情、位置和示例，请参阅 [管理员强制要求](zh/pages/67-managed-configuration.md#admin-enforced-requirements-requirementstoml)。
...
在 workspace-write 模式中，某些环境会让 `.git/` 和 `.codex/` 保持只读，即使工作区其余部分可写也是如此。这就是 `git commit` 等命令可能仍需要审批才能在沙盒外运行的原因。如果你希望 Codex 跳过特定命令（例如阻止沙盒外的 `git commit`），请使用 [Rules](zh/pages/54-rules.md)。
...
有关遥测的更多安全与隐私指导，请参阅 [Security](zh/pages/13-agent-approvals-security.md#monitoring-and-telemetry)。
...
确切键名请参阅 [配置参考](zh/pages/16-configuration-reference.md)。
...
详细 walkthrough 请参阅 [Custom instructions with AGENTS.md](zh/pages/50-custom-instructions-with-agents-md.md)。
...
完整键列表请参阅 [配置参考](zh/pages/16-configuration-reference.md)。
...
将此示例配置用作起点。它包含 Codex 从 `config.toml` 读取的大多数键，以及默认行为、适用时的推荐值和简短说明。
...
特定使用界面的命令、设置、worktree 行为、互联网访问和运行细节。
...
CLI 会从 `~/.codex/config.toml` 继承大多数默认值。你在命令行传入的任何 `-c key=value` 覆盖都会在该次调用中优先。更多信息请参阅 [配置基础](zh/pages/19-config-basics.md#configuration-precedence)。
...
“成熟度”列使用 Experimental、Beta 和 Stable 等功能成熟度标签。请参阅 [功能成熟度](zh/pages/03-feature-maturity.md) 了解如何解释这些标签。

| 键 | 成熟度 | 说明 |
| --- | --- | --- |
| [codex](zh/pages/22-cli-command-reference.md#codex-interactive) | `stable` | 启动终端 UI。接受上面的全局标志，以及可选提示词或图片附件。 |
...
| [codex debug app-server send-message-v2](zh/pages/22-cli-command-reference.md#codex-debug-app-server-send-message-v2) | `experimental` | 通过内置测试客户端发送单条 V2 消息来调试 app-server。 |
| [codex debug models](zh/pages/22-cli-command-reference.md#codex-debug-models) | `experimental` | 打印 Codex 看到的原始模型目录，并可选择只检查捆绑的模型目录。 |
| [codex apply](zh/pages/22-cli-command-reference.md#codex-apply) | `stable` | 将 Codex Cloud 任务生成的最新 diff 应用到你的本地工作树。别名：`codex a`。 |
| [codex archive](zh/pages/22-cli-command-reference.md#codex-archive-and-codex-unarchive) | `stable` | 按 session ID 或 session name 归档已保存的交互式会话。 |
| [codex cloud](zh/pages/22-cli-command-reference.md#codex-cloud) | `experimental` | 从终端浏览或执行 Codex Cloud 任务，而不打开 TUI。别名：`codex cloud-tasks`。 |
| [codex completion](zh/pages/22-cli-command-reference.md#codex-completion) | `stable` | 为 Bash、Zsh、Fish 或 PowerShell 生成 shell 补全脚本。 |
| [codex doctor](zh/pages/22-cli-command-reference.md#codex-doctor) | `stable` | 为本地安装、配置、身份验证、运行时、Git、终端、app-server 和线程清单问题生成诊断报告。 |
| [codex features](zh/pages/22-cli-command-reference.md#codex-features) | `stable` | 列出功能标志，并在 `config.toml` 中持久启用或禁用它们。 |
| [codex exec](zh/pages/22-cli-command-reference.md#codex-exec) | `stable` | 非交互式运行 Codex。别名：`codex e`。将结果流式输出到 stdout 或 JSONL，并可选择恢复之前的会话。 |
| [codex execpolicy](zh/pages/22-cli-command-reference.md#codex-execpolicy) | `experimental` | 评估 execpolicy 规则文件，并查看某个命令会被允许、提示还是阻止。 |
...
| [codex mcp](zh/pages/22-cli-command-reference.md#codex-mcp) | `experimental` | 管理 Model Context Protocol 服务器（list、add、remove、authenticate）。 |
| [codex plugin marketplace](zh/pages/22-cli-command-reference.md#codex-plugin-marketplace) | `experimental` | 从 Git 或本地源 add、list、upgrade 或 remove plugin marketplace。 |
| [codex plugin](zh/pages/22-cli-command-reference.md#codex-plugin) | `experimental` | 从已配置 marketplace source 安装、列出和移除插件。 |
| [codex mcp-server](zh/pages/22-cli-command-reference.md#codex-mcp-server) | `experimental` | 通过 stdio 将 Codex 本身作为 MCP 服务器运行。当另一个智能体使用 Codex 时很有用。 |
| [codex resume](zh/pages/22-cli-command-reference.md#codex-resume) | `stable` | 按 ID 继续之前的交互式会话，或恢复最近的对话。 |
| [codex fork](zh/pages/22-cli-command-reference.md#codex-fork) | `stable` | 将之前的交互式会话 fork 为新线程，同时保留原始 transcript。 |
...
| [codex unarchive](zh/pages/22-cli-command-reference.md#codex-archive-and-codex-unarchive) | `stable` | 按 session ID 或 session name 恢复已归档的交互式会话。 |
...
- [Codex CLI 概览](zh/pages/45-codex-cli.md)：安装、升级和快速提示。
- [配置基础](zh/pages/19-config-basics.md)：持久化模型和提供商等默认值。
- [高级配置](zh/pages/17-advanced-configuration.md)：配置档、提供商、沙箱调优和集成。
- [AGENTS.md](zh/pages/50-custom-instructions-with-agents-md.md)：Codex 智能体能力和最佳实践的概念性概览。
...
3. Codex 应用你的互联网访问设置。设置脚本会带互联网访问权限运行。智能体互联网访问默认关闭，但如有需要，你可以启用受限或不受限访问。请参阅 [智能体互联网访问](zh/pages/23-agent-internet-access.md)。
...
互联网访问在设置脚本阶段可用，用于安装依赖。在智能体阶段，互联网访问默认关闭，但你可以配置受限或不受限访问。请参阅 [智能体互联网访问](zh/pages/23-agent-internet-access.md)。
...
[观看 Introducing the Codex app 视频](https://www.youtube.com/watch?v=HFM3se4lNiw)。

---

#### 跨项目多任务处理 { #multitask-across-projects }

使用一个 Codex app 窗口跨项目运行任务。为每个代码库添加一个项目，并按需在它们之间切换。

当你的 Codex desktop app 中可用时，你可以要求 Codex 管理本地项目或 worktree 中的线程。例如，要求它查找相关线程、继续现有线程，或固定或归档一个线程。要创建独立的后台线程，请明确提出该请求：`Create a separate background thread in a worktree for this project to update the tests.`
...
![Codex app 显示侧边栏中的多个项目和主面板中的线程](https://developers.openai.com/images/codex/app/multitask-light.webp)
...
![Codex app 中显示可用 skills 的 Skills picker](https://developers.openai.com/images/codex/app/skill-selector-light.webp)

#### 自动化 { #automations }

你还可以将 skills 与[自动化](zh/pages/24-automations.md)结合，以执行日常任务，例如评估遥测中的错误并提交修复，或创建近期代码库变更报告。对于应保持在一个线程中的持续工作，请使用[线程自动化](zh/pages/24-automations.md)。

![带有 schedule 和 prompt 字段的 automation 创建表单](https://developers.openai.com/images/codex/app/create-automation-light.webp)
...
- **Local**：直接在当前项目目录中工作。
- **Worktree**：在 Git worktree 中隔离更改。[了解更多](zh/pages/42-worktrees.md)。
- **Cloud**：在已配置的云环境中远程运行。
...
![带有 Local、Worktree 和 Cloud 模式选项的新线程输入框](https://developers.openai.com/images/codex/app/modes-light.webp)

#### 内置 Git 工具 { #built-in-git-tools }
...
![带有 commit message 字段的 Git diff 和 commit 面板](https://developers.openai.com/images/codex/app/git-commit-light.webp)

#### 工作树支持 { #worktree-support }
...
![显示 branch actions 和 worktree details 的 Worktree 线程视图](https://developers.openai.com/images/codex/app/worktree-light.webp)

#### 集成终端 { #integrated-terminal }

每个线程都包含一个内置终端，作用域限定到当前项目或 worktree。使用 app 右上角的终端图标，或按 `Cmd+J` 来切换它。
...
![在 Codex 线程下方打开的集成终端抽屉](https://developers.openai.com/images/codex/app/integrated-terminal-light.webp)

#### 原生 Windows 沙盒 { #native-windows-sandbox }
...
![Codex app Windows sandbox setup prompt above the message composer](https://developers.openai.com/images/codex/windows/windows-sandbox-setup.webp)

#### 语音听写 { #voice-dictation }

使用语音提示 Codex。当输入框可见时按住 `Ctrl+M` 并开始说话。你的语音会被转写。编辑转写后的提示词，或点击发送让 Codex 开始工作。

![输入框中的语音听写指示器和已转写 prompt](https://developers.openai.com/images/codex/app/voice-dictation-light.webp)

#### 浮动弹出窗口 { #floating-pop-out-window }

将活动对话线程弹出到单独窗口，并移动到你正在工作的地方。这非常适合前端工作，因为你可以在快速迭代时将线程放在浏览器、编辑器或设计预览附近。

当你希望它在整个工作流中保持可见时，也可以将弹出窗口切换为置顶显示。

![浅色模式下的 pop-out window preview](https://developers.openai.com/images/codex/app/popover-light.webp)

#### 应用内浏览器 { #in-app-browser }

使用[应用内浏览器](zh/pages/36-in-app-browser.md)在迭代 web app 时预览、审查和评论本地开发服务器、基于文件的预览，以及不需要登录的公开页面。

应用内浏览器不支持身份验证流程、已登录页面、你的常规浏览器 profile、cookies、extensions 或现有 tabs。

使用浏览器评论标记页面上的特定元素或区域，然后要求 Codex 处理该反馈。

当你希望 Codex 直接操作页面时，请对本地开发服务器和基于文件的页面使用 [browser use](zh/pages/36-in-app-browser.md)。你可以从设置管理 Browser plugin、允许的网站和阻止的网站。

![Codex app 在本地 web app preview 上显示 browser comment](https://developers.openai.com/images/codex/app/in-app-browser-light.webp)
...
![Codex app 请求使用 Calculator 的 computer use 权限](https://developers.openai.com/images/codex/app/computer-use-approval-light.webp)

<a id="task-sidebar"></a>
<a id="artifact-viewer"></a>

#### 处理非代码产物 { #richer-outputs-and-artifacts }
...
使用任务侧边栏跟踪 Codex 在线程运行期间正在做什么。它可以展示 agent 的计划、来源、生成 artifacts 和任务摘要，使你能够引导工作、检查生成文件，并决定哪些地方需要再处理。

![Codex app 在 artifact viewer 中显示生成的 presentation](https://developers.openai.com/images/codex/app/artifact-viewer-light.webp)

---

#### 与 IDE 扩展同步 { #sync-with-the-ide-extension }
...
#### 审批和沙盒 { #approvals-and-sandboxing }
...
如果你的 workspace 中可用[自动审核](zh/pages/13-agent-approvals-security.md)，你可以从权限选择器中选择它。它保持相同的沙盒边界，但会通过已配置的审核策略路由符合条件的审批请求，而不是等待你。

有关高层概览，请参阅[沙盒](zh/pages/15-sandbox.md)。有关配置细节，请参阅[智能体审批与安全文档](zh/pages/13-agent-approvals-security.md)。

#### MCP 支持 { #mcp-support }

Codex app、CLI 和 IDE Extension 共享 [Model Context Protocol (MCP)](zh/pages/53-model-context-protocol.md) 设置。如果你已经在其中一个界面配置了 MCP servers，其它界面会自动采用这些配置。要配置新服务器，请打开 app 设置中的 MCP 部分，并启用推荐服务器或向配置添加新服务器。
...
直接在线程中要求 Codex 生成或编辑图像。这适用于 UI assets、banners、backgrounds、illustrations、sprite sheets，以及你希望与代码一起创建的 placeholders。当你希望 Codex 转换或扩展现有资产时，请添加参考图像。

你可以用自然语言提出请求，也可以通过在提示词中包含 `$imagegen` 来显式调用图像生成 skill。

内置图像生成使用 `gpt-image-2`，计入你的通用 Codex 用量限制，并且平均消耗包含额度的速度比不带图像生成的类似轮次快 3-5 倍，具体取决于图像质量和尺寸。详情请参阅[定价](zh/pages/02-codex-pricing.md)。有关提示技巧和模型细节，请参阅[图像生成指南](https://developers.openai.com/api/docs/guides/image-generation)。

对于更大批量的图像生成，请在你的环境变量中设置 `OPENAI_API_KEY`，并要求 Codex 通过 API 生成图像，这样将按 API 定价计费。

#### 图片输入 { #image-input }

你可以将图片拖放到 prompt composer 中，把它们作为上下文。拖放图片时按住 `Shift` 可将图片添加到上下文中。

你也可以要求 Codex 查看系统上的图片。通过给 Codex 提供对你正在处理的 app 截图的工具，Codex 可以验证它正在做的工作。

<a id="projectless-threads"></a>

#### Chats { #chats }

Chats 是在任务不需要特定项目文件夹或 Git 仓库时可以启动的线程。它们适用于 research、triage、planning、plugin-heavy workflows，以及其他希望 Codex 使用已连接工具而不是编辑代码库的对话。

Chats 使用 Codex 管理的 `threads` 目录作为工作位置，该目录位于你的 Codex home 下。默认位置是 `~/.codex/threads`。

#### Memories { #memories }

[Memories](zh/pages/74-memories.md) 在可用时让 Codex 将过去任务中的有用上下文带入未来线程。它们最适合稳定偏好、项目约定、重复工作模式，以及否则需要反复说明的已知陷阱。

#### 通知 { #notifications }

默认情况下，当任务完成或 app 在后台时需要审批，Codex app 会发送通知。

在 Codex app 设置中，你可以选择永不发送通知，或即使 app 处于焦点中也始终发送通知。

#### 保持电脑唤醒 { #keep-your-computer-awake }

由于你的任务可能需要一段时间才能完成，你可以在 app 设置中启用 "Prevent sleep while running" 开关，让 Codex app 防止电脑进入睡眠。

#### 另请参阅 { #see-also }

- [Settings](zh/pages/28-codex-app-settings.md)
- [Automations](zh/pages/24-automations.md)
- [In-app browser](zh/pages/36-in-app-browser.md)
- [Computer use](zh/pages/35-computer-use.md)
- [Review pane](zh/pages/38-review.md)
- [Local environments](zh/pages/37-local-environments.md)
- [Worktrees](zh/pages/42-worktrees.md)
...
对于 Codex app 中的 SSH 远程项目，请使用[远程连接](zh/pages/79-remote-connections.md)。对于托管的远程控制客户端，`codex remote-control` 会启动启用了远程控制支持的 app-server 进程。
...
使用 Codex 子智能体工作流来并行化更大的任务。关于设置、角色配置（`config.toml` 中的 `[agents]`）和示例，请参阅[子智能体](zh/pages/81-subagents-2.md)。
...
内置图片生成使用 `gpt-image-2`，计入你的常规 Codex 使用限制；根据图片质量和尺寸，消耗包含额度的速度平均比没有图片生成的类似回合快 3-5 倍。详情请参阅[定价](zh/pages/02-codex-pricing.md#image-generation-usage-limits)。提示技巧和模型详情请参阅[图像生成指南](https://developers.openai.com/api/docs/guides/image-generation)。
...
请参阅[斜杠命令指南](zh/pages/39-slash-commands-in-codex-cli.md)，浏览内置命令目录、了解如何编写自定义命令，以及它们在磁盘上的位置。
...
请参阅 [Model Context Protocol](zh/pages/53-model-context-protocol.md)，了解示例配置、支持的认证流程和更详细指南。
...
#### 在模型之间切换 { #switch-between-models }

你可以使用聊天输入框下方的切换器切换模型。

![Codex 模型切换器](https://developers.openai.com/images/codex/ide/switch_model.png){ style="max-width: 20rem; width: 100%; height: auto;" }

#### 调整推理强度 { #adjust-reasoning-effort }
...
#### 选择批准模式 { #choose-an-approval-mode }
...
![Codex 批准模式](https://developers.openai.com/images/codex/ide/approval_mode.png){ style="max-width: 18rem; width: 100%; height: auto;" }

如果你需要 Codex 在无需批准的情况下读取文件、进行编辑，并带网络访问运行命令，请使用 `Agent (Full Access)`。这样做前请谨慎。

#### 云端委派 { #cloud-delegation }
...
![从 IDE 启动云任务](https://developers.openai.com/images/codex/ide/start_cloud_task.png){ style="max-width: 42rem; width: 100%; height: auto;" }

当你从本地对话启动云任务时，Codex 会记住对话上下文，以便从你离开的地方继续。

#### 云任务后续处理 { #cloud-task-follow-up }

Codex 扩展让预览云端变更变得直接。你可以要求后续任务在云端运行，但通常你会想把变更应用到本地，以便测试和收尾。当你在本地继续对话时，Codex 也会保留上下文来节省时间。

![将云任务加载到 IDE](https://developers.openai.com/images/codex/ide/load_cloud_task.png){ style="max-width: 42rem; width: 100%; height: auto;" }

你也可以在 [Codex cloud 界面](https://chatgpt.com/codex) 中查看云任务。

#### 网页搜索 { #web-search }

Codex 随附第一方网页搜索工具。对于 Codex IDE 扩展中的本地任务，Codex 默认启用网页搜索，并从网页搜索缓存提供结果。该缓存是 OpenAI 维护的网页结果索引，因此缓存模式会返回预索引结果，而不是抓取实时页面。这减少了暴露于任意实时内容中提示注入的风险，但你仍应将网页结果视为不可信。如果你将沙盒配置为 [Full Access](zh/pages/13-agent-approvals-security.md)，网页搜索默认使用实时结果。请参阅[配置基础](zh/pages/19-config-basics.md)，了解如何禁用网页搜索或切换到会抓取最新数据的实时结果。

每当 Codex 查找内容时，你会在转录记录或 `codex exec --json` 输出中看到 `web_search` 项。

#### 将图片拖放到提示中 { #drag-and-drop-images-into-the-prompt }
...
ChatGPT Plus、Pro、Business、Edu 和 Enterprise 计划包含 Codex。请查看[包含哪些内容](zh/pages/02-codex-pricing.md)了解更多。
...
- [跨项目多任务](zh/pages/27-codex-app-features.md#multitask-across-projects)：并排运行项目线程，并在它们之间快速切换。
- [Worktrees](zh/pages/42-worktrees.md)：使用内置 Git worktree 支持，让并行代码变更保持隔离。
- [远程连接](zh/pages/79-remote-connections.md)：使用 ChatGPT mobile app 在已连接主机上启动、引导、审批并审查 Codex 工作。
- [Computer use](zh/pages/35-computer-use.md)：让 Codex 使用 macOS app 完成 GUI 任务、浏览器流程和原生 app 测试。
- [Appshots](zh/pages/43-appshots.md)：把最前方的 Mac app 窗口连同截图和可用文本发送给 Codex。
- [审查并发布变更](zh/pages/38-review.md)：检查 diff、处理 PR 反馈、暂存文件、提交并推送。
- [终端和 actions](zh/pages/27-codex-app-features.md#integrated-terminal)：在每个线程中运行命令，并启动可重复的项目 actions。
- [In-app browser](zh/pages/36-in-app-browser.md)：打开渲染后的页面、留下评论，或让 Codex 操作本地浏览器流程。
- [Chrome extension](zh/pages/29-codex-chrome-extension.md)：添加 Chrome plugin，让 Codex 可以使用 Chrome 执行已登录的浏览器任务，同时由你管理网站审批。
- [图片生成](zh/pages/27-codex-app-features.md#image-generation)：在线程中生成或编辑图片，同时处理周边代码和素材。
- [自动化](zh/pages/24-automations.md)：排定 recurring tasks，或唤醒同一线程进行持续检查。
- [Skills](zh/pages/27-codex-app-features.md#skills-support)：在 app、CLI 和 IDE Extension 中复用说明和工作流。
- [侧边栏和 artifacts](zh/pages/27-codex-app-features.md#richer-outputs-and-artifacts)：跟踪计划、来源、任务摘要和生成文件预览。
- [Plugins](zh/pages/78-plugins.md)：连接 apps、skills 和 MCP servers，扩展 Codex 能做的事。
- [Sites](zh/pages/80-sites.md)：使用 Sites plugin 构建和部署托管网站、web apps 和游戏。
- [IDE Extension sync](zh/pages/27-codex-app-features.md#sync-with-the-ide-extension)：在 app 和 IDE 会话之间共享 Auto Context 和活动线程。

需要帮助？请访问[故障排除指南](zh/pages/40-troubleshooting.md)。
...
ChatGPT Plus、Pro、Business、Edu 和 Enterprise 计划均包含 Codex。请查看[包含哪些内容](zh/pages/02-codex-pricing.md)了解更多。
...
Codex CLI 可在 macOS、Windows 和 Linux 上使用。在 Windows 上，可以在 PowerShell 中配合 Windows 沙箱原生运行 Codex；当你需要 Linux 原生环境时，也可以使用 WSL2。设置详情请参阅 [Windows 设置指南](zh/pages/83-windows-platform.md)。
</div>
...
- [交互式运行 Codex](zh/pages/30-codex-cli-features.md#running-in-interactive-mode)：运行 `codex` 启动交互式终端 UI（TUI）会话。
- [控制模型和推理](zh/pages/30-codex-cli-features.md#models-and-reasoning)：使用 `/model` 在 GPT-5.4、GPT-5.3-Codex 和其他可用模型之间切换，或调整推理级别。
- [图片输入](zh/pages/30-codex-cli-features.md#image-inputs)：附加截图或设计规格，让 Codex 在阅读 prompt 时一并参考。
- [图片生成](zh/pages/30-codex-cli-features.md#image-generation)：直接在 CLI 中生成或编辑图片；当你希望 Codex 基于现有素材迭代时，也可以附加参考图。
- [运行本地代码审查](zh/pages/30-codex-cli-features.md#running-local-code-review)：在提交或推送变更之前，让一个独立的 Codex agent 审查你的代码。
- [使用 subagents](zh/pages/68-subagents.md)：使用 subagents 并行处理复杂任务。
- [Web search](zh/pages/30-codex-cli-features.md#web-search)：让 Codex 搜索网页，为任务获取最新信息。
- [Codex Cloud 任务](zh/pages/30-codex-cli-features.md#working-with-codex-cloud)：无需离开终端即可启动 Codex Cloud 任务、选择环境并应用生成的 diff。
- [脚本化 Codex](zh/pages/60-non-interactive-mode.md)：使用 `exec` 命令编写脚本，自动化可重复工作流。
- [Model Context Protocol](zh/pages/53-model-context-protocol.md)：通过 Model Context Protocol（MCP）让 Codex 访问额外的第三方工具和上下文。
- [审批模式](zh/pages/30-codex-cli-features.md#approval-modes)：在 Codex 编辑或运行命令前，选择与你舒适度匹配的审批模式。
...
适用于 VS Code-compatible editors 和 JetBrains IDEs 的 Codex IDE integrations 可在 macOS、Windows 和 Linux 上使用。在 Windows 上，可以配合 Windows sandbox 原生运行 Codex；当你需要 Linux 原生环境时，也可以使用 WSL2。设置详情请参阅 [Windows 设置指南](zh/pages/83-windows-platform.md)。
...
安装 extension 后，它会提示你使用 ChatGPT 账户或 API key 登录。你的 ChatGPT 计划包含使用额度，因此无需额外设置即可使用 Codex。可在[定价页面](zh/pages/02-codex-pricing.md)了解更多信息。
...
你也可以参考 [Codex IDE extension commands](zh/pages/31-codex-ide-extension-commands.md) 页面。支持的 slash commands 列表见 [Codex IDE extension slash commands](zh/pages/34-codex-ide-extension-slash-commands.md)。如果你刚开始使用 Codex，请阅读[最佳实践指南](zh/pages/05-best-practices.md)。

---

#### 使用 Codex IDE extension 工作

- [使用编辑器上下文提示](zh/pages/32-codex-ide-extension-features.md)：使用打开的文件、选区和 `@file` 引用，让较短的 prompt 得到更相关的结果。
- [切换模型](zh/pages/32-codex-ide-extension-features.md)：使用默认模型，或切换到其他模型以利用各自优势。
- [调整推理强度](zh/pages/32-codex-ide-extension-features.md)：选择 `low`、`medium` 或 `high`，根据任务在速度和深度之间取舍。
- [图片生成](zh/pages/32-codex-ide-extension-features.md)：无需离开编辑器即可生成或编辑图片；需要迭代时可使用参考素材。
- [选择审批模式](zh/pages/32-codex-ide-extension-features.md)：根据你希望 Codex 拥有多少自主权，在 `Chat`、`Agent` 和 `Agent (Full Access)` 之间切换。
- [委派到云端](zh/pages/32-codex-ide-extension-features.md)：把较长的作业 offload 到云端环境，然后无需离开 IDE 即可监控进度并审查结果。
- [跟进云端工作](zh/pages/32-codex-ide-extension-features.md)：预览云端变更、请求后续处理，并把生成的 diff 应用到本地以测试和收尾。
- [IDE extension commands](zh/pages/31-codex-ide-extension-commands.md)：浏览可从命令面板运行并绑定到键盘快捷键的完整命令列表。
- [Slash commands](zh/pages/34-codex-ide-extension-slash-commands.md)：使用 slash commands 控制 Codex 行为，并从 chat 快速更改常用设置。
- [Extension settings](zh/pages/33-codex-ide-extension-settings.md)：通过模型、审批和其他默认值等 editor settings，把 Codex 调整到适合你的工作流。
...
你的 Plus、Pro、Business、Edu 或 Enterprise 计划包含 Codex。请查看[包含哪些内容](zh/pages/02-codex-pricing.md)了解更多。某些 Enterprise workspace 可能需要先完成[管理员设置](zh/pages/64-admin-setup.md)，然后你才能访问 Codex。

---

#### 使用 Codex 网页版工作

- [了解提示编写](zh/pages/07-prompting.md#prompts)：编写更清晰的 prompts，添加约束，并选择合适的详细程度，以获得更好的结果。
- [常见工作流](zh/pages/06-example-workflows.md)：从经过验证的模式开始，用于委派任务、审查变更，并将结果转换为 PR。
- [配置环境](zh/pages/25-cloud-environments.md)：选择 repo、setup steps，以及 Codex 在云端运行任务时应使用的工具。
- [从 IDE extension 委派工作](zh/pages/32-codex-ide-extension-features.md)：从编辑器启动 cloud task，然后监控进度并在本地应用生成的 diff。
- [从 GitHub 委派](zh/pages/49-codex-code-review-in-github.md)：在 issues 和 pull requests 中标记 `@codex`，即可启动任务并直接从 GitHub 提议变更。
- [控制互联网访问](zh/pages/23-agent-internet-access.md)：决定 Codex 是否可以从云端环境访问公共互联网，以及何时启用它。
...
用户通过本地 `[auto_review].policy` 自定义；详见[高级配置](zh/pages/17-advanced-configuration.md#approval-policies-and-sandbox-modes)。
...
`[auto_review].policy`；详见[高级配置](zh/pages/17-advanced-configuration.md#approval-policies-and-sandbox-modes)，
但托管要求优先级更高：
...
- 添加窄作用域的[前缀规则](zh/pages/54-rules.md)。相比 `["python"]` 或 `["curl"]` 等宽泛
  模式，优先选择精确命令
...
| 术语 | 适用范围 | 定义 |
| --- | --- | --- |
| [Agent](zh/pages/01-codex.md) | App, CLI, IDE 扩展, Cloud | 在上下文上推理、使用工具并完成任务的 Codex 工作单元。 |
| [AGENTS.md](zh/pages/50-custom-instructions-with-agents-md.md) | App, CLI, IDE 扩展, Cloud | 为 Codex 提供持久说明的仓库或用户指导文件。 |
| [Analytics dashboard](zh/pages/66-governance.md#analytics-dashboard) | 企业 | 用于查看 Codex 使用情况、采用情况和代码审查指标的管理员视图。 |
| [API key sign-in](zh/pages/18-authentication-and-sessions.md#sign-in-with-an-api-key) | App, CLI, IDE 扩展 | 使用 OpenAI API key 进行身份验证。 |
| [Approval policy](zh/pages/13-agent-approvals-security.md#sandbox-and-approvals) | App, CLI, IDE 扩展 | 规定 Codex 何时必须在采取操作前请求确认的规则。 |
| [Approval request](zh/pages/13-agent-approvals-security.md#automatic-approval-reviews) | App, CLI, IDE 扩展 | Codex 请求允许执行受限制操作。 |
| [Apps (connectors)](zh/pages/78-plugins.md) | App, CLI, IDE 扩展 | 让 Codex 访问外部服务的集成。可通过插件获得，也称为 connectors。 |
| [Appshot](zh/pages/43-appshots.md) | App | 发送到 Codex 线程的最前方 app 窗口快照。 |
| [Auth cache](zh/pages/18-authentication-and-sessions.md#login-caching) | App, CLI, IDE 扩展 | 本地保存并由 Codex 复用的登录凭据。 |
| [Automatic approval review](zh/pages/13-agent-approvals-security.md#automatic-approval-reviews) | App, CLI, IDE 扩展 | 在符合条件的审批请求继续之前进行的模型审查。 |
| [Automation](zh/pages/24-automations.md) | App | 计划执行或重复执行的 Codex 任务。 |
| [Automation run](zh/pages/24-automations.md#managing-tasks) | App | 一次计划自动化执行，可能报告发现或将自身归档。 |
| [Browser use](zh/pages/36-in-app-browser.md#browser-use) | App | 让 Codex 直接操作 app 内浏览器的 app 功能。 |
| [Chat](zh/pages/27-codex-app-features.md#chats) | App | 不绑定到项目的 Codex 对话。 |
| [ChatGPT sign-in](zh/pages/18-authentication-and-sessions.md#sign-in-with-chatgpt) | App, CLI, IDE 扩展, Cloud | 使用 ChatGPT 账户和工作区权限进行身份验证。 |
| [Chronicle](zh/pages/70-chronicle.md) | App | 从近期屏幕上下文构建记忆的可选功能。 |
| [Cloud](zh/pages/47-codex-web.md) | App, IDE 扩展, Web | Codex 在 OpenAI 托管环境中远程工作的模式。 |
| [Cloud environment](zh/pages/25-cloud-environments.md) | Cloud | 用于 Codex cloud 任务的已配置容器设置。 |
| [Cloud task](zh/pages/25-cloud-environments.md#how-codex-cloud-tasks-run) | Cloud | 在云环境中远程执行的 Codex 任务。 |
| [Cloud thread](zh/pages/07-prompting.md#threads) | Cloud | 在 Codex cloud 环境中运行的线程。 |
| [Codex](zh/pages/01-codex.md) | App, CLI, IDE 扩展, Web, Cloud, SDK | OpenAI 面向软件开发任务的 coding agent。 |
| [Codex app](zh/pages/44-codex-app.md) | 桌面端 | 用于并行运行 Codex 线程的桌面 app，内置 worktree、自动化和 Git 功能。 |
| [Codex app-server](zh/pages/57-codex-app-server.md) | App, IDE 扩展, SDK | 本地 JSON-RPC 服务器，用于在自定义客户端中嵌入 Codex 线程、轮次、审批、历史和流式事件。 |
| [Codex CLI](zh/pages/45-codex-cli.md) | 终端 | 用于以交互方式或脚本方式运行 Codex 的终端客户端。 |
| [Codex cloud](zh/pages/47-codex-web.md) | Web, App, IDE 扩展 | OpenAI 托管的执行环境，Codex 可在其中远程处理仓库任务。 |
| [codex exec](zh/pages/60-non-interactive-mode.md) | CLI | 用于从脚本或 CI 非交互运行 Codex 的 CLI 命令。 |
| [Codex IDE extension](zh/pages/46-codex-ide-extension.md) | IDE | 在 VS Code、JetBrains IDE、Cursor 和 Windsurf 等 IDE 中使用 Codex 的编辑器集成。 |
| [Codex SDK](zh/pages/59-codex-sdk.md) | SDK | 用于构建 Codex 驱动工作流或集成的编程接口。 |
| [Codex web](zh/pages/47-codex-web.md) | 浏览器 | 用于委派 cloud 任务的浏览器版 Codex 界面。 |
| [Codex-managed worktree](zh/pages/42-worktrees.md#codex-managed-and-permanent-worktrees) | App | Codex 为某个线程创建并管理的临时 worktree。 |
| [Compaction](zh/pages/07-prompting.md#context) | App, CLI, IDE 扩展, Cloud | 总结较早上下文，使长时间运行的工作可以继续。 |
| [Compliance API](zh/pages/66-governance.md#compliance-api) | 企业 | 用于导出 Codex 活动和审计元数据的 API。 |
| [Computer use](zh/pages/35-computer-use.md) | App | 让 Codex 通过 UI 与桌面应用交互的 app 功能。 |
| [config.toml](zh/pages/16-configuration-reference.md#configtoml) | App, CLI, IDE 扩展 | 本地 Codex 配置文件。 |
| [Connected host](zh/pages/79-remote-connections.md#what-comes-from-the-connected-host) | App, 移动端 | 为远程 Codex 工作提供文件、工具和 shell 访问的计算机或开发环境。 |
| [Connector](zh/pages/78-plugins.md) | App, Cloud | 让 Codex 访问外部服务的 app 集成。可通过插件获得，也称为 apps。 |
| [Container cache](zh/pages/25-cloud-environments.md#container-caching) | Cloud | 保存的 cloud 容器状态，用于加速后续任务。 |
| [Context](zh/pages/07-prompting.md#context) | App, CLI, IDE 扩展, Cloud, SDK | Codex 工作时可使用的信息，例如文件、先前消息、工具输出和说明。 |
...
| [Custom agent](zh/pages/81-subagents-2.md#custom-agents) | App, CLI | 带有自身说明和设置的用户定义 agent 角色。 |
| [Deny-read rule](zh/pages/77-permissions.md#deny-reads-with-exact-paths-or-globs) | App, CLI, IDE 扩展, 企业 | 阻止 Codex 读取敏感路径或 glob 匹配项的文件系统权限规则。 |
| [Diff](zh/pages/38-review.md#what-changes-it-shows) | App, Git, 审查 | 用于检查、评论、暂存或还原的一组 Git 文件变更。 |
| [Domain allowlist](zh/pages/23-agent-internet-access.md#domain-allowlist) | Cloud | 启用 agent 互联网访问时 Codex cloud 可访问的一组域名。 |
| [Environment (local)](zh/pages/37-local-environments.md) | App, Worktree | 用于告诉 Codex 如何为项目设置 worktree 的 app 配置。 |
| [Environment variable](zh/pages/25-cloud-environments.md#environment-variables-and-secrets) | Cloud, CLI, IDE 扩展 | 任务执行期间可用的运行时配置值。 |
| [Ephemeral session](zh/pages/60-non-interactive-mode.md#basic-usage) | CLI | 完成后跳过保存会话状态的非交互运行。 |
| [Fast mode](zh/pages/08-speed.md#fast-mode) | CLI, IDE 扩展 | 让受支持模型以更高点数成本更快响应的速度设置。 |
| [Filesystem permission](zh/pages/77-permissions.md#filesystem-permissions) | App, CLI, IDE 扩展 | 授予或拒绝路径读写访问的权限配置规则。 |
| [Finding](zh/pages/24-automations.md#managing-tasks) | App | 自动化发现并呈现的重要结果或问题。 |
| [Full access](zh/pages/15-sandbox.md#configure-defaults) | App, CLI, IDE 扩展 | Codex 在没有常规沙盒限制的情况下运行的模式。 |
| [Git worktree](zh/pages/42-worktrees.md#whats-a-worktree) | App, Git | 同一仓库的第二个 checkout，用于并行分支工作。 |
| [Handoff](zh/pages/42-worktrees.md#working-between-local-and-worktree) | App | 在线程及其工作内容在 Local 和 Worktree 之间移动。 |
| [Heartbeat](zh/pages/24-automations.md#thread-automations) | App | 按计划将 Codex 带回同一对话的重复线程唤醒，也称为 thread automation。 |
| [Hook](zh/pages/73-hooks.md) | App, CLI, IDE 扩展 | 当 Codex 事件匹配时运行的生命周期处理程序，例如工具使用、权限请求或轮次停止。 |
| [Hook event](zh/pages/73-hooks.md#config-shape) | App, CLI, IDE 扩展 | 已配置 hook handler 可以运行的生命周期节点。 |
| [Hunk](zh/pages/38-review.md#staging-and-reverting-files) | App, Git, 审查 | diff 中可独立暂存、取消暂存或还原的连续片段。 |
| [Inline comment](zh/pages/38-review.md#inline-comments-for-feedback) | App | 附加到 diff 特定行的反馈。 |
| [Live web search](zh/pages/19-config-basics.md#web-search-mode) | App, CLI, IDE 扩展 | 用于获取最新信息的实时网页查询。 |
| [Local](zh/pages/42-worktrees.md#working-between-local-and-worktree) | App, CLI, IDE 扩展 | Codex 在用户电脑上工作的模式。 |
| [Local thread](zh/pages/07-prompting.md#threads) | App, CLI, IDE 扩展 | 在用户机器上运行的线程。 |
| [Maintenance script](zh/pages/25-cloud-environments.md#container-caching) | Cloud | 缓存的 cloud 容器恢复时可运行的可选脚本。 |
| [Managed configuration](zh/pages/67-managed-configuration.md) | 企业 | 组织控制的 Codex 默认值和限制。 |
| [MCP](zh/pages/53-model-context-protocol.md) | App, CLI, IDE 扩展 | Model Context Protocol，一种将 Codex 连接到外部工具和上下文的标准。 |
| [MCP resource](zh/pages/53-model-context-protocol.md#supported-mcp-features) | App, CLI, IDE 扩展 | MCP server 暴露给 Codex 检查的可读上下文。 |
| [MCP server](zh/pages/53-model-context-protocol.md#supported-mcp-features) | App, CLI, IDE 扩展 | 通过 MCP 暴露的外部工具或上下文提供者。 |
| [MCP tool](zh/pages/53-model-context-protocol.md#supported-mcp-features) | App, CLI, IDE 扩展 | MCP server 暴露并可由 Codex 在任务中调用的操作。 |
| [MDM](zh/pages/67-managed-configuration.md#macos-managed-preferences-mdm) | 企业 | 用于分发设备配置文件和托管 Codex 设置的移动设备管理工具。 |
| [Memories](zh/pages/74-memories.md) | App, CLI, IDE 扩展 | Codex 可跨会话复用的本地存储上下文。 |
| [Model](zh/pages/20-model-selection.md) | App, CLI, IDE 扩展, Cloud, SDK | Codex 用于推理和工具工作的 AI 模型。 |
| [Network access](zh/pages/13-agent-approvals-security.md#network-access-) | App, CLI, IDE 扩展, Cloud | 命令或环境访问互联网的权限。 |
| [Network policy](zh/pages/13-agent-approvals-security.md#network-policy) | App, CLI, IDE 扩展 | 约束沙盒出站网络流量的基于域名的允许和拒绝规则。 |
| [Non-interactive mode](zh/pages/60-non-interactive-mode.md) | CLI | 从脚本或 CI 运行 Codex 的 CLI 模式。 |
| [Output schema](zh/pages/60-non-interactive-mode.md#create-structured-outputs-with-a-schema) | CLI | 传递给 `codex exec`、用于约束最终响应的 JSON Schema。 |
| [Permanent worktree](zh/pages/42-worktrees.md#codex-managed-and-permanent-worktrees) | App | 作为独立项目保留的长期 worktree。 |
| [Permission profile](zh/pages/77-permissions.md#define-and-select-a-profile) | App, CLI, IDE 扩展 | 组合本地命令执行的文件系统和网络规则的命名最小权限策略。 |
| [Plan](zh/pages/05-best-practices.md#plan-first-for-difficult-tasks) | App, CLI, IDE 扩展, Cloud | Codex 为完成任务提出或跟踪的步骤。 |
| [Plugin](zh/pages/78-plugins.md) | App, CLI, IDE 扩展 | 可分发 skills、tools 和 integrations 的可安装 bundle。 |
| [Plugin manifest](zh/pages/69-build-plugins.md#plugin-structure) | App, CLI, IDE 扩展, 插件 | 标识插件并指向内含 skills、apps、MCP servers、hooks 和 metadata 的插件元数据文件。 |
| [Prefix rule](zh/pages/54-rules.md#understand-the-rules-language) | App, CLI, IDE 扩展, 企业 | 允许、提示或禁止匹配命令前缀的命令规则模式。 |
| [Profile](zh/pages/17-advanced-configuration.md#profiles) | CLI, IDE 扩展 | Codex 的命名配置预设。 |
| [Progressive disclosure](zh/pages/48-agent-skills.md) | App, CLI, IDE 扩展 | 仅在需要时加载 skill 细节，以节省上下文。 |
| [Project](zh/pages/27-codex-app-features.md#multitask-across-projects) | App | Codex 工作的已选代码库或文件夹。 |
| [Prompt](zh/pages/07-prompting.md) | App, CLI, IDE 扩展, Cloud, SDK | 发送给 Codex 的用户说明或请求。 |
| [Pull request review](zh/pages/38-review.md#pull-request-reviews) | App, CLI, GitHub | Codex 对变更的审查，或对 pull request 的反馈。 |
| [RBAC](zh/pages/64-admin-setup.md#step-2-set-up-custom-roles-rbac) | 企业 | 用于工作区权限的基于角色的访问控制。 |
| [Read-only mode](zh/pages/15-sandbox.md) | App, CLI, IDE 扩展 | Codex 可检查但未经批准不能修改的模式。 |
| [Reasoning effort](zh/pages/19-config-basics.md#reasoning-effort) | App, CLI, IDE 扩展, SDK | 控制模型使用多少推理预算的设置。 |
| [Remote connection](zh/pages/79-remote-connections.md) | App, 移动端 | 让 Codex 通过已连接 host 从另一台设备工作的连接。 |
| [requirements.toml](zh/pages/16-configuration-reference.md#requirementstoml) | 企业 | 用于托管 Codex 设置的管理员强制 requirements 文件。 |
| [Review pane](zh/pages/38-review.md) | App | 用于检查 diff、评论和 Git 变更的 app 视图。 |
| [Rules](zh/pages/54-rules.md) | App, CLI, IDE 扩展 | 允许、提示或拒绝命令前缀或权限例外的策略。 |
| [Sandbox](zh/pages/15-sandbox.md) | App, CLI, IDE 扩展 | 限制 Codex 命令可访问或可修改内容的强制边界。 |
| [Sandbox mode](zh/pages/19-config-basics.md#sandbox-level) | App, CLI, IDE 扩展 | 定义 Codex 文件系统和网络限制的配置。 |
| [Sandbox preset](zh/pages/59-codex-sdk.md#sandbox-presets) | SDK | SDK 中表示常见沙盒策略的简写，例如 read-only、workspace-write 或 full access。 |
| [Schedule](zh/pages/24-automations.md) | App | 自动化的计时规则。 |
| [Secret](zh/pages/25-cloud-environments.md#environment-variables-and-secrets) | Cloud | 可用于 setup scripts、但会在 agent 阶段前移除的加密值。 |
| [Setup script](zh/pages/37-local-environments.md#setup-scripts) | App worktrees | 在 agent 开始前运行，用于安装依赖或准备工具的脚本。 |
| [Skill](zh/pages/48-agent-skills.md) | App, CLI, IDE 扩展 | 带有说明以及可选脚本或参考资料的可复用工作流包。 |
| [Skill invocation](zh/pages/48-agent-skills.md#how-codex-uses-skills) | App, CLI, IDE 扩展 | 显式或隐式激活 skill。 |
| [Slash command](zh/pages/39-slash-commands-in-codex-cli.md) | CLI | 以斜杠开头、用于控制或检查 Codex CLI 会话的命令。 |
| [Standalone automation](zh/pages/24-automations.md) | App | 报告独立 findings 的独立计划运行。 |
| [STDIO MCP server](zh/pages/53-model-context-protocol.md#stdio-servers) | CLI, IDE 扩展 | 由已配置命令和参数作为本地进程启动的 MCP server。 |
| [Streamable HTTP MCP server](zh/pages/53-model-context-protocol.md#streamable-http-servers) | CLI, IDE 扩展 | 通过 HTTP 访问的 MCP server，可选使用 bearer token 或 OAuth 身份验证。 |
| [Subagent](zh/pages/68-subagents.md) | App, CLI | 被派生出来处理部分任务的专门 child agent。 |
| [Subagent workflow](zh/pages/68-subagents.md#core-terms) | App, CLI | Codex 并行运行委派 agents 并合并其结果的工作流。 |
| [Task](zh/pages/24-automations.md#managing-tasks) | App, CLI, IDE 扩展, Cloud, SDK | Codex 被要求完成的工作单位。 |
| [Thread](zh/pages/07-prompting.md#threads) | App, CLI, IDE 扩展, Cloud, SDK | 包含 prompts、模型输出和工具活动的单个 Codex 会话。 |
| [Thread automation](zh/pages/24-automations.md#thread-automations) | App | 附加到现有 thread 的重复唤醒，也称为 heartbeat。 |
| [Thread fork](zh/pages/57-codex-app-server.md#start-or-resume-a-thread) | app-server, SDK | 从现有 thread 的存储历史分支出来的新 thread。 |
| [Turn](zh/pages/57-codex-app-server.md#core-primitives) | App, CLI, IDE 扩展, Cloud, SDK | thread 中的一轮交换，通常包括用户 prompt 以及 Codex 的响应和操作。 |
| [Universal image](zh/pages/25-cloud-environments.md#default-universal-image) | Cloud | 带有常用工具的默认 Codex cloud 容器镜像。 |
| [Web search cache](zh/pages/19-config-basics.md#web-search-mode) | App, CLI, IDE 扩展 | Codex 可在不实时浏览的情况下使用的预索引搜索结果。 |
| [Worktree](zh/pages/42-worktrees.md) | App | Codex 在独立 Git worktree 中隔离变更的模式。 |
| [Writable roots](zh/pages/13-agent-approvals-security.md#protected-paths-in-writable-roots) | App, CLI, IDE 扩展 | Codex 被允许修改的目录。 |
...
OpenAI 以开放方式开发 Codex 的关键部分。这些工作位于 GitHub 上，因此你可以跟踪进展、报告问题并贡献改进。

如果你维护一个被广泛使用的开源项目，或想提名维护重要项目的维护者，也可以 [申请 Codex for OSS 计划](https://developers.openai.com/community/codex-for-oss)，以获得 API credits、带 Codex 的 ChatGPT Pro，以及对 Codex Security 的选择性访问。

#### 开源组件

| 组件                        | 位置                                                                                              | 说明                                               |
| --------------------------- | ------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| Codex CLI                   | [openai/codex](https://github.com/openai/codex)                                                   | Codex 开源开发的主要位置 |
| Codex SDK                   | [openai/codex/sdk](https://github.com/openai/codex/tree/main/sdk)                                 | SDK 源码位于 Codex 仓库中 |
| Codex App Server            | [openai/codex/codex-rs/app-server](https://github.com/openai/codex/tree/main/codex-rs/app-server) | App-server 源码位于 Codex 仓库中 |
| Skills                      | [openai/skills](https://github.com/openai/skills)                                                 | 扩展 Codex 的可复用 skills |
| IDE 扩展                    | -                                                                                                 | 不开源 |
| Codex web                   | -                                                                                                 | 不开源 |
| 通用云环境                  | [openai/codex-universal](https://github.com/openai/codex-universal)                               | Codex cloud 使用的基础环境 |

#### 在哪里报告问题和请求功能

使用 Codex GitHub 仓库为各 Codex 组件提交错误报告和功能请求：

- 错误报告和功能请求：[openai/codex/issues](https://github.com/openai/codex/issues)
- 讨论论坛：[openai/codex/discussions](https://github.com/openai/codex/discussions)

提交 issue 时，请尽可能包含你正在使用的组件（CLI、SDK、IDE 扩展、Codex web）和版本。
...
Codex cloud 的网络设置请参阅 [Internet Access](zh/pages/23-agent-internet-access.md)。
...
企业管理员可以通过托管的 `requirements.toml` 定义配置档，并限制用户可以选择哪些配置档。一旦出现 `allowed_permission_profiles`，未列出的配置档都会被拒绝，包括未列出的内置配置档和未来 Codex 版本添加的配置档。推荐的托管配置请参阅[控制可用权限配置档](zh/pages/67-managed-configuration.md#control-available-permission-profiles)。
...
配置档描述会话的本地默认姿态。组织托管要求仍然可以添加用户配置不应放宽的限制。管理员强制执行的文件系统和网络约束请参阅[托管配置](zh/pages/67-managed-configuration.md)。
...
- 在原生 Windows 上，[`elevated` 沙箱](zh/pages/83-windows-platform.md#windows-sandbox) 最强，因为它可以使用专门的低权限沙箱用户、文件系统权限边界和防火墙规则。`unelevated` 沙箱是较弱网络隔离的 fallback，不能执行每个 split read/write carveout，因此不受支持的策略会被拒绝。当你需要 Linux 沙箱模型时，请使用 WSL。
