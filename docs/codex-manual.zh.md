...
- [跨项目多任务](zh/pages/27-codex-app-features.md)：并排运行项目线程，并在它们之间快速切换。
...
- [终端和 actions](zh/pages/27-codex-app-features.md)：在每个线程中运行命令，并启动可重复的项目 actions。
...
- [图片生成](zh/pages/27-codex-app-features.md)：在线程中生成或编辑图片，同时处理周边代码和素材。
- [自动化](zh/pages/24-automations.md)：排定 recurring tasks，或唤醒同一线程进行持续检查。
- [Skills](zh/pages/27-codex-app-features.md)：在 app、CLI 和 IDE Extension 中复用说明和工作流。
- [侧边栏和 artifacts](zh/pages/27-codex-app-features.md)：跟踪计划、来源、任务摘要和生成文件预览。
...
- [IDE Extension sync](zh/pages/27-codex-app-features.md)：在 app 和 IDE 会话之间共享 Auto Context 和活动线程。
